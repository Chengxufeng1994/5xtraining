                            ...
                            <div className="col-12 col-md-6 contact-info">
                                ...
                                <div className="col-12 d-flex flex-wrap px-0">
                                    ...
                                    <br />
                                        Mobile：0928-617-687
                                    <br />
                                        E-mail： <a className="mail" href="/">hi@5xruby.tw</a>
                                    </div>
                            ...
                            <div className="col-12 col-md-6 contact-form">
                                ...
                                <form onSubmit={this.toggle}>
                                    <div className="form-group">
                                        <input type="text" className="form-control" id="name" placeholder="名字" required autoComplete="off" value={this.state.name} onChange={event => this.setState({ name: event.target.value })} />
                                    </div>
                                    <div className="form-group">
                                        <input type="email" className="form-control" id="email" placeholder="信箱" required autoComplete="off" value={this.state.email} onChange={event => this.setState({ email: event.target.value })} />
                                    </div>
                                    <div className="form-group">
                                        <input type="text" className="form-control" id="phone" placeholder="電話" required autoComplete="off" value={this.state.phone} onChange={event => this.setState({ phone: event.target.value })} />
                                    </div>
                                    <div className="form-group">
                                        <select className="form-control" required value={this.state.subject} onChange={event => this.setState({ theme: event.target.value })}>
                                    ...
                                    <div className="form-group">
                                        <textarea className="form-control" id="message" rows="3" placeholder="留下你的訊息" required autoComplete="off" value={this.state.message} onChange={event => this.setState({ message: event.target.value })}></textarea>
                                    </div>
