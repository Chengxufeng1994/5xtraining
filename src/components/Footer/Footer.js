                    ...
                    <div className="row">
                        <div className="col-12 col-md-3">
                            ...
                            <a className="d-block cakeresume press-img" href="/#" target="_blank">
                                <img src="https://5xruby.tw/assets/images/footer/cakeresume-8938f367.png"
                                    title="CakeResume 找工作"
                                    alt="CakeResume 找工作"
                                    style={{ maxWidth: "180px", marginBottom: "10px", paddingRight: "6px" }} /><span className="text-muted">找工作</span>
                            </a>
                        </div>
                                    ...
                                    <div className="row">
                                        <div className="col-12 col-md-4 col-xl-3">
                                            <div className="contact-info">
                                                ...
                                                <a href="https://github.com/5xruby" target="_blank" rel="noopener noreferrer"><i className="social-icon fab fa-github" ></i></a>
                                            </div>
                                        </div>
